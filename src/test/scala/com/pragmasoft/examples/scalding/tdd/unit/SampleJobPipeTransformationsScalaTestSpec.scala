package com.pragmasoft.examples.scalding.tdd.unit
...
import com.pragmasoft.examples.scalding.pattern.puretransformations._

@RunWith(classOf[JUnitRunner])
class SampleJobPipeOperationsScalaTestSpec extends FlatSpec with Matchers with TupleConversions with TestInfrastructure {
